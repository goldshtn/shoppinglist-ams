...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String GCM_SENDER_ID = "134753106886";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mobileServiceClient = CloudClient.initClient(this);
            NotificationsManager.handleNotifications(
                    this, GCM_SENDER_ID, PushNotificationHandler.class);
    ...
    private void authenticate() {
        Futures.addCallback(
                mobileServiceClient.login(MobileServiceAuthenticationProvider.Twitter),
                new FutureCallback<MobileServiceUser>() {
                    @Override
                    public void onSuccess(MobileServiceUser result) {
                        Toast.makeText(MainActivity.this,
                                "Logged in as " + result.getUserId(), Toast.LENGTH_LONG).show();
                        setupList();
                    }

                    @Override
                    public void onFailure(Throwable t) {
                        Log.e("MainActivity", "Authentication failure: " + t.toString());
                        finish();
                    }
                }
        );
    ...
    private void setupList() {
        ...
        itemsAdapter = new CartItemAdapter(this, mobileServiceClient);
